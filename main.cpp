#include "src/utils/rtweekend.h"

#include "src/geometries/hittable_list.h"
#include "src/geometries/sphere.h"
#include "src/view/camera.h"
#include "src/textures/material.h"
#include "src/geometries/moving_sphere.h"
            ...
            if ((center - point3(4, 0.2, 0)).length() > 0.9) {
                ...
                if (choose_mat < 0.8) {
                    ...
                    world.add(make_shared<moving_sphere>(
                            center, center2, 0.0, 1.0, 0.2, sphere_material));                } else if (choose_mat < 0.95) {
                    // metal
...
hittable_list earth() {
    auto earth_texture = make_shared<image_texture>("../imgs/resources/earthmap.jpg");
...
hittable_list final_scene() {
    ...
    auto emat = make_shared<lambertian>(make_shared<image_texture>("../imgs/resources/earthmap.jpg"));
    ...
    for (int j = image_height-1; j >= 0; --j) {
        ...
        for (int i = 0; i < image_width; ++i) {
            ...
            for (int s = 0; s < samples_per_pixel; ++s) {
                ...
                pixel_color += ray_color(r, background, bvh_tree, max_depth); // use bvh to accelerate rt
            }
